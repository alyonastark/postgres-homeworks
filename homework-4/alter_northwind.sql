...
SELECT * INTO order_details_discontinued FROM order_details WHERE product_id NOT IN (SELECT product_id FROM products);

DELETE FROM order_details WHERE product_id NOT IN (SELECT product_id FROM products);

SELECT * INTO orders_discontinued FROM orders WHERE order_id NOT IN (SELECT order_id FROM order_details);
